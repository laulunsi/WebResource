<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HtmlFormater.aspx.cs" Inherits="HC.WebSite.DataFormat.HtmlFormater" %>
...
<body>
    ...
    <div id="mainForm" class="right_main">
        ...
        <fieldset class="demo_content output">
            <legend>输出：</legend>
            <textarea id="output" style="height: 200px; width: 99%">
            </textarea>
        </fieldset>
    </div>
