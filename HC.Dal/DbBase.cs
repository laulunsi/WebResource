...
namespace HC.Dal
{
    public class DbBase<T> where T : class
    {
        ...
        {
            return DbHelper.CurrentDb.ExecuteScalar<int>(string.Format("SELECT MAX(id) FROM {0}", tableName)).ToInt();
        }
        ...
        {
            return DbHelper.CurrentDb.Query<TRet>(new[] { typeof(T1), typeof(T2) }, cb, sql, args);
        }

        public IEnumerable<TRet> Query<T1, T2, T3, TRet>(Func<T1, T2, T3, TRet> cb, string sql, params object[] args)
        {
            return DbHelper.CurrentDb.Query<TRet>(new[] { typeof(T1), typeof(T2), typeof(T3) }, cb, sql, args);
        }

        public IEnumerable<TRet> Query<T1, T2, T3, T4, TRet>(Func<T1, T2, T3, T4, TRet> cb, string sql,
                                                             params object[] args)
        {
            return DbHelper.CurrentDb.Query<TRet>(new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4) }, cb, sql,
                                                  args);
        }
        ...
        {
            return DbHelper.CurrentDb.Query<TRet>(new[] { typeof(T1), typeof(T2) }, cb, sql.SQL, sql.Arguments);
        }

        public IEnumerable<TRet> Query<T1, T2, T3, TRet>(Func<T1, T2, T3, TRet> cb, Sql sql)
        {
            return DbHelper.CurrentDb.Query<TRet>(new[] { typeof(T1), typeof(T2), typeof(T3) }, cb, sql.SQL,
                                                  sql.Arguments);
        }

        public IEnumerable<TRet> Query<T1, T2, T3, T4, TRet>(Func<T1, T2, T3, T4, TRet> cb, Sql sql)
        {
            return DbHelper.CurrentDb.Query<TRet>(new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4) }, cb,
        ...
        {
            return DbHelper.CurrentDb.Query<T1>(new[] { typeof(T1), typeof(T2) }, null, sql, args);
        }

        public IEnumerable<T1> Query<T1, T2, T3>(string sql, params object[] args)
        {
            return DbHelper.CurrentDb.Query<T1>(new[] { typeof(T1), typeof(T2), typeof(T3) }, null, sql, args);
        }

        public IEnumerable<T1> Query<T1, T2, T3, T4>(string sql, params object[] args)
        {
            return DbHelper.CurrentDb.Query<T1>(new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4) }, null, sql,
                                                args);
        }
        ...
        {
            return DbHelper.CurrentDb.Query<T1>(new[] { typeof(T1), typeof(T2) }, null, sql.SQL, sql.Arguments);
        }

        public IEnumerable<T1> Query<T1, T2, T3>(Sql sql)
        {
            return DbHelper.CurrentDb.Query<T1>(new[] { typeof(T1), typeof(T2), typeof(T3) }, null, sql.SQL,
                                                sql.Arguments);
        }

        public IEnumerable<T1> Query<T1, T2, T3, T4>(Sql sql)
        {
            return DbHelper.CurrentDb.Query<T1>(new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4) }, null,
                                                sql.SQL, sql.Arguments);
        }
    }
}