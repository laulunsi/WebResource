...
namespace HC.Dal
{
    ...
    public class Database : IDisposable
    {
        ...
        public object Insert(object poco, int autoIncrement)
        {
            var pd = PocoData.ForType(poco.GetType());
        ...
        public class ExpandoColumn : PocoColumn
        {
            ...
            public override object GetValue(object target)
            {
                ...
                var dictionary = target as IDictionary<string, object>;
                if (dictionary != null)
                    dictionary.TryGetValue(ColumnName, out val);
                return val;
            }
        ...
        public class PocoData
        {
            ...
            public Delegate GetFactory(string sql, string connString, bool ForceDateTimesToUtc, int firstColumn, int countColumns, IDataReader r)
            {
                ...
                try
                {
                    ...
                    // Create the method
                    var m = new DynamicMethod("petapoco_factory_" + PocoFactories.Count.ToString(CultureInfo.InvariantCulture), type, new Type[] { typeof(IDataReader) }, true);
                    var il = m.GetILGenerator();
